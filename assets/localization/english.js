const english = {
    ...
    enterTheEmailAddeessAssociatedWithYourAccount : 'Enter the email addeess associated with your account',
    resetPassword : 'Reset Password',
    invalidEmail: 'invalid email',
    emailAddress : 'email address',
    success : 'Success',
    linkToResetPasswordSenttoEmail : 'link to reset your password sent to you email',
    ...
    chargers: 'chargers',
    noQueue : 'no queue',
    thisChargerBusySelectFree :"this charger is currently busy, please select a free charger",
    currentQueueStatus: 'current queue status',
    pleaseCreateQueueOntheVehicleScreen : 'please create queue on the vehicle screen',
   ...
   // Login : 'Login',
    ...
    manageyourCharging : 'Manage your  charging station and queue with GOveho charger',
